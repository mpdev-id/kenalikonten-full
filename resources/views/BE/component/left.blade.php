<section class="grow-0 w-[180px] min-h-screen py-4 bg-white border-r border-neutral-300 flex-col justify-start items-center gap-[52px] inline-flex">
    ...
    <div class="self-stretch h-[228px] flex-col justify-start items-start gap-3 flex">
        ...
        <div class="self-stretch h-9 px-3 {{ request()->is('*/donatur') ? 'border-r-2 border-red-400' : '' }} justify-start items-center gap-2 inline-flex  hover:border-r-2 hover:border-red-400 ">
            <div class="w-6 h-6 relative"></div>
            <a href="{{ route('dashboard.donatur.index') }}" class="{{ request()->is('*/donatur') ? '  text-red-400 text-base font-normal ' : 'text-neutral-400 text-base font-normal' }} hover:text-red-400">Donatur</a>
        </div>
        <div class="self-stretch h-9 px-3 {{ request()->is('*/konten-post') ? 'border-r-2 border-red-400' : '' }} justify-start items-center gap-2 inline-flex  hover:border-r-2 hover:border-red-400 ">
            <div class="w-6 h-6 relative"></div>
            <a href="{{ route('dashboard.post.index') }}" class="{{ request()->is('*/konten-post') ? '  text-red-400 text-base font-normal ' : 'text-neutral-400 text-base font-normal' }} hover:text-red-400">Post</a>
        </div>
    </div>
</section>