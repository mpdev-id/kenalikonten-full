        ...
        <table class="min-w-full text-left text-sm font-light ">
          <thead class="border-b font-medium bg-emerald-500 bg-red-100 ">
            <tr class="p-2">
              ...
              <div
                class="w-9 h-[60px] p-2 bg-red-100 justify-start items-center gap-0.5 inline-flex">
                <div class="text-zinc-800 text-sm font-semibold font-['Poppins']">No</div>
              </div>
              <div
                class="w-[450px] h-[60px] p-2 bg-red-100 justify-start items-center gap-0.5 inline-flex">
                <div class="text-zinc-800 text-sm font-semibold font-['Poppins']">Nama Jenis Tim
                </div>
              </div>
              <div
                class="w-[450px] h-[60px] p-2 bg-red-100 justify-start items-center gap-0.5 inline-flex">
              ...
              <div
                class="w-[124px] h-[60px] p-2 bg-red-100 justify-start items-center gap-0.5 inline-flex">
            ...
            <tr class="border-b boder-2">
              ...
              <td class="whitespace-nowrap px-6 py-4 flex">
                ...
                {{-- <button
                  ...
                  onclick="editModal('{{ $item->id }}')">Edit</button> --}}
