...
<section
  ...
  <div class="tab {{ $team->id }} max-sm:px-5  sm:px-8 w-full bg-white shadow-xl relative mb-1 rounded-xl max-lg:m-4">
    ...
    <div
      ...
      <div class="grid grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1 max-sm:w-full lg:max-w-max gap-2 mx-auto pb-5 ">
